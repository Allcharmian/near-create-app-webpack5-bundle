  ...
  if (!window.walletConnection.isSignedIn()) {
    return (
      <main>
		...
		<p>This bundle was built to save time for people building with Near, React and Webpack5,
		check <a title="source of code" href="https://dev.to/riyanegi/setting-up-webpack-5-with-react-and-babel-from-scratch-2021-271l" target="_bank">This Tut</a> to further investigate the code.</p>
        <p>
